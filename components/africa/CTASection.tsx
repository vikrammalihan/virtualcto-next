        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <div className="inline-flex items-center space-x-2 px-4 py-2 bg-indigo-50 dark:bg-indigo-900/20 rounded-full border border-indigo-200 dark:border-indigo-800 mb-6">
              ...
              <span className="text-sm font-medium text-indigo-700 dark:text-indigo-300">Let&apos;s Connect</span>
            </div>
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed mb-8">
              Schedule a free 30-minute consultation to discuss your technology challenges and explore how fractional CTO services can help you succeed in African markets.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <div className="font-semibold text-slate-900 dark:text-white mb-1">Local Time Zone Support</div>
                  <div className="text-sm text-slate-600 dark:text-slate-400">Available during African business hours</div>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <div className="font-semibold text-slate-900 dark:text-white mb-1">Pan-African Experience</div>
                  <div className="text-sm text-slate-600 dark:text-slate-400">Deep knowledge of local markets</div>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <div className="font-semibold text-slate-900 dark:text-white mb-1">Free Consultation</div>
                  <div className="text-sm text-slate-600 dark:text-slate-400">No obligation, just valuable insights</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-50 dark:bg-slate-800 rounded-2xl p-6 sm:p-8 border border-slate-200 dark:border-slate-700">
            <form id="africa-consultation-form" data-readdy-form onSubmit={handleSubmit} className="space-y-6">
              <div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="w-full px-4 py-3 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg text-slate-900 dark:text-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 focus:outline-none transition-colors text-sm"
                >
