          ...
          {mobileMenuOpen && (
            <div className="lg:hidden py-4 border-t border-slate-200 dark:border-slate-800">
              <div className="flex flex-col space-y-3">
                ...
                <button onClick={() => scrollToSection('services')} className="px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors cursor-pointer text-left">Services</button>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="grid grid-cols-3 gap-4 sm:gap-6 pt-4">
                <div>
                  <div className="text-2xl sm:text-3xl font-bold text-indigo-600 dark:text-indigo-400">25+</div>
                  <div className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 mt-1">Years Experience</div>
                </div>
                <div>
                  <div className="text-2xl sm:text-3xl font-bold text-indigo-600 dark:text-indigo-400">100+</div>
                  <div className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 mt-1">Startups Guided</div>
                </div>
                <div>
                  <div className="text-2xl sm:text-3xl font-bold text-indigo-600 dark:text-indigo-400">$50M+</div>
                  <div className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 mt-1">Tech Decisions</div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-6 pt-6 border-t border-slate-200 dark:border-slate-800">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-slate-600 dark:text-slate-400">Multi-Industry Expertise</span>
                </div>
                <div className="flex items-center space-x-2">
                  <i className="ri-global-line text-indigo-600 dark:text-indigo-400 text-xl"></i>
                  <span className="text-sm text-slate-600 dark:text-slate-400">Global Reach</span>
                </div>
              </div>
            </div>
              ...
              <div className="absolute -bottom-6 -left-6 right-6 sm:right-auto sm:w-80 bg-white dark:bg-slate-800 rounded-xl shadow-xl p-6 border border-slate-200 dark:border-slate-700">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-600 dark:text-slate-400 mt-1">Fractional CTO &amp; Technology Advisor</div>
                    <div className="flex items-center space-x-1 mt-2">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <i key={star} className="ri-star-fill text-yellow-400 text-sm"></i>
                      ))}
                      <span className="text-xs text-slate-600 dark:text-slate-400 ml-2">5.0 Rating</span>
                    </div>
                  </div>
                </div>
              </div>
